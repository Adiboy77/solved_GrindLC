...
If character match with the characters of t, increment the count variable
if count==length of t (t_len) => we found a window with all characters of t
Minimize the window size by removing extra characters from the start of window (using win_left for this).
Keep updating window of smaller length
Print substring of the smallest window found.
